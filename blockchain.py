...
open_transactions = []
# Im the the owner of this blockchain node, hence this is our identifier (e.g. for sending coins)
owner = 'Mia'
        ...
        for block in blockchain:
            updated_block = {
                ...
                'transactions': [OrderedDict(
                    [('sender', tx['sender']), 
                    ('recipient', tx['recipient']), ('amount', tx['amount'])]) for tx in block['transactions']]
            } 
...
def proof_of_work():
# Proof of work for mining. Generates a proof of work for the open transactions, the hash of the previous block and a random number (which is guessed until it fits).
